...
public class ReadDoubleInputEvent extends ReadingDataListener<Double> {
    @Override
    protected void readNextData(AsynchronousSocketChannel asyncServerSocket, ResponseCallback<Double> callback) {
